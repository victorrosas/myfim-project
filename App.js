import React, { useState, useRef, screenWidth, screenHeigth } from 'react';
import { View, SafeAreaView, ScrollView, Text, StyleSheet, 
  Dimensions, ImageBackground, TextInput, TouchableOpacity, Image } from 'react-native';
